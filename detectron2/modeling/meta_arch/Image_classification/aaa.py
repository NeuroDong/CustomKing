...
class VIT(nn.Module):
    def __init__(self,cfg, image_size = (32,32), patch_size=(16,16),dim = 768, depth = 12, heads = 12, mlp_dim = 3072, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
    ...
    def forward(self, data):
        ...
        #------------------网络推理--------------------------#
        x = self.to_patch_embedding(batch_images_tensor)
        b, n, _ = x.shape
