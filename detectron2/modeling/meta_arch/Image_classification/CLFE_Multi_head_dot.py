...
class Dot_add(nn.Module):
    #Dot multiplication and addition
    def __init__(self):
        super(Dot_add, self).__init__()
        self.params = nn.Parameter(torch.randn((512,224,224)))
...
class CLFE_Multi_head_dot(nn.Module):
