...
def densenet_k12_D40(cfg, **kwargs: Any) ->DenseNet:
    model = _densenet('densenet_k12_D40', 12, (5, 10, 20, 0), 64, num_classes = cfg.num_classes,**kwargs)
...
def densenet121(cfg, **kwargs: Any) -> DenseNet:
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet121', 32, (6, 12, 24, 16), 64, num_classes = cfg.num_classes,
                     **kwargs)
...
def densenet161(cfg, **kwargs: Any) -> DenseNet:
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet161', 48, (6, 12, 36, 24), 96, num_classes = cfg.num_classes,
                     **kwargs)
...
def densenet169(cfg, **kwargs: Any) -> DenseNet:
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet169', 32, (6, 12, 32, 32), 64, num_classes = cfg.num_classes,
                     **kwargs)
...
def densenet201(cfg, **kwargs: Any) -> DenseNet:
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet201', 32, (6, 12, 48, 32), 64, num_classes = cfg.num_classes,
                     **kwargs)